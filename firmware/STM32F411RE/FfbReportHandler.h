...
class FfbReportHandler {
  public:
    ...
    volatile USB_FFBReport_PIDStatus_Input_Data_t pidState = {
      2,      // Report ID
      0x1E,   // actuators enabled + safety + override + power
      0
    };
...
extern volatile uint32_t dbgSetEffectCount;
extern volatile uint32_t dbgConstantCount;
extern volatile uint32_t dbgOperationCount;
extern volatile uint32_t dbgBlockFreeCount;

extern volatile uint8_t dbgLastSetBlock;
extern volatile uint8_t dbgLastSetType;
extern volatile int16_t dbgLastMagnitude;
extern volatile uint8_t dbgLastOpBlock;
extern volatile uint8_t dbgLastOperation;

extern volatile uint16_t dbgConstantLen;
extern volatile int16_t dbgRawConstantMagnitude;
